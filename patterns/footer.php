...
<div class="wp-block-ainoblocks-grid-item col_start_d__1 col_end_d__13 col_start_t__1 col_end_t__13 col_start_m__1 col_end_m__13 align-self__center justify-self__stretch no-stacking mt_d__0 center"><!-- wp:paragraph {"align":"left","textColor":"font-secondary","fontSize":"text-xs"} -->
<p class="has-text-align-left has-font-secondary-color has-text-color has-text-xs-font-size"><?php
			printf(
